...
$mq5 = "$MQL5_BASE\EA - Budak Ubat v1.65 - MT5 - Market Edition.mq5"
...
$ex5 = "$MQL5_BASE\EA - Budak Ubat v1.65 - MT5 - Market Edition.ex5"
if (Test-Path $ex5) {
    $item = Get-Item $ex5
    ...
    Copy-Item $ex5 "mql5-market-package\EA - Budak Ubat v1.65 - MT5 - Market Edition.ex5" -Force
    Copy-Item $mq5 "mql5-market-package\EA - Budak Ubat v1.65 - MT5 - Market Edition.mq5" -Force

    if (Test-Path "C:\Users\User\OneDrive\Desktop\ea bu mt5") {
        Copy-Item $ex5 "C:\Users\User\OneDrive\Desktop\ea bu mt5\EA - Budak Ubat v1.65 - MT5 - Market Edition.ex5" -Force
        Copy-Item $mq5 "C:\Users\User\OneDrive\Desktop\ea bu mt5\EA - Budak Ubat v1.65 - MT5 - Market Edition.mq5" -Force
    }
