              ...
              >
                <div className="partner-broker-content">
                  ...
                  <div className="partner-broker-meta-bar" style={{ marginTop: "18px", paddingTop: "12px", borderTop: "1px solid rgba(255, 255, 255, 0.08)" }}>
                    <span>{p.is_mql5 ? "PRICE:" : "ACCESS:"} <strong className="partner-broker-code-highlight" style={{ color: "#10b981" }}>{p.price}</strong></span>
                    {p.is_mql5 ? (
                      <span style={{ color: "#38bdf8", fontSize: "0.78rem" }}>🛒 MQL5 Market</span>
                    ) : (
                      <span style={{ color: "#10b981", fontSize: "0.78rem" }}>🤝 Partner Whitelist</span>
                    )}
                  </div>
                </div>
